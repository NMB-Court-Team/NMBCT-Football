...
execute if score #is_prev_not_start football_lobby.temp matches 0 if score #is_curr_not_start football_lobby.temp matches 1 run function football_lobby:on_finished
execute if score #is_prev_not_start football_lobby.temp matches 1 if score #is_curr_not_start football_lobby.temp matches 0 run function football_lobby:on_start
