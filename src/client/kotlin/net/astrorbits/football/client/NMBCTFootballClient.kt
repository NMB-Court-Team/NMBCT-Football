...
import net.astrorbits.football.client.match.*
import net.astrorbits.football.client.render.*
...
object NMBCTFootballClient : ClientModInitializer {
	override fun onInitializeClient() {
		...
		HudElementRegistry.addLast(
			Identifier.fromNamespaceAndPath(NMBCTFootball.MOD_ID, "goal_kick_hint_hud"),
			GoalKickHintHudElement()
		)
