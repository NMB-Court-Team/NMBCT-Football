...
import net.astrorbits.football.config.server.GoalkeeperSettings
import net.astrorbits.football.config.server.ParticleSettings
import net.astrorbits.football.config.server.PhysicsCollisionSettings
import net.astrorbits.football.config.server.PhysicsCoreSettings
import net.astrorbits.football.config.server.PhysicsKickSettings
import net.astrorbits.football.config.server.PhysicsSettings
import net.astrorbits.football.config.server.PlayerDribbleSettings
import net.astrorbits.football.config.server.PlayerInputSettings
import net.astrorbits.football.config.server.PlayerKickSettings
import net.astrorbits.football.config.server.GoalkeeperCatchSettings
import net.astrorbits.football.config.server.GoalkeeperDiveSettings
import net.astrorbits.football.config.server.ParticleActionCounts
